...
contract AddConsumer is Script, Constants {
    ...
    function addConsumerUsingConfig() public {
        ...
        addConsumer(vrfCoordinator, subscriptionId, raffleAddress);
    }

    function addConsumer(address vrfCoordinator, uint256 subscriptionId, address raffleAddress) public {
